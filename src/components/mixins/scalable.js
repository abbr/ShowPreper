...
exports.onScaleMouseDown = function (ev, idx) {
  ...
  this.props.selectedWidgets.forEach(e => {
    ...
    scalable.osx = (this.props.component.components[e].scale && this.props.component.components[e].scale.x) || 1
    scalable.osy = (this.props.component.components[e].scale && this.props.component.components[e].scale.y) || 1
