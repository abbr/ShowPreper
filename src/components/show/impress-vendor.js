...
export function Impress(document, window) {
  ...
  var computeWindowScale = function(config, el) {
    var width = config.width
    var height = config.height
    if (el && el.dataset) {
      width = parseInt(el.dataset.width) || width
      height = parseInt(el.dataset.height) || height
    }
    var hScale = window.innerHeight / height,
      wScale = window.innerWidth / width,
  ...
  var impress = (window.impress = function(rootId) {
    ...
    var goto = function(el, duration) {
      ...
      // Force computing window scaling for every slide to support
      // per-slide width height
      windowScale = computeWindowScale(config, el)
      ...
      css(root, {
        ...
        transform:
          perspective(config.perspective / targetScale) + scale(targetScale),
